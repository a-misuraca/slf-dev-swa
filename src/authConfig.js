...
export const msalConfig = {
  auth: {
    ...
    redirectUri: "https://calm-beach-00fd54803.4.azurestaticapps.net/.auth/login/aad/callback", // Points to window.location.origin. You must register this URI on Microsoft Entra admin center/App Registration.
